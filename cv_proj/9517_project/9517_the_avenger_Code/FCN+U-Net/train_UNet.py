...
def start_train(opt):
    ...
    model = UNet()
    model_path = 'ckpt/UNet_epoch_2_train_loss_0.32091076139247776_val_loss0.2758457865968025.pth'
    ...
    for e in range(opt.num_epoch):
        ...
        model_name = f"UNet_epoch_{e}_train_loss_{train_loss}_val_loss{val_loss}.pth"
